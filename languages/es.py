...
'(**%.0d MB**)': '(**%.0d MB**)',
'(Filtrado de _MAX_ enlaces totales)': '(Filtrado de _MAX_ enlaces totales)',
'(Filtrado de _MAX_ Enlaces Totales)': '(Filtrado de _MAX_ Enlaces Totales)',
'(Filtrado de _MAX_ entidades Totales)': '(Filtrado de _MAX_ entidades Totales)',
'(Filtrado de _MAX_ envios Totales)': '(Filtrado de _MAX_ envios Totales)',
'(Filtrado de _MAX_ Municipios Totales)': '(Filtrado de _MAX_ Municipios Totales)',
'(Filtrado de _MAX_ total enlaces)': '(Filtrado de _MAX_ total enlaces)',
...
'Configurar provincia': 'Configurar provincia',
'contains': 'contains',
...
'Código del reporte': 'Código del reporte',
...
'El enlace se ha actualizado correctamente': 'El enlace se ha actualizado correctamente',
'El enlace se ha creado correctamente': 'El enlace se ha creado correctamente',
'El entidad se ha actualizado correctamente': 'El entidad se ha actualizado correctamente',
...
'El formato de fecha debe ser día/mes/año': 'El formato de fecha debe ser día/mes/año',
'El municipio se ha actualizado correctamente': 'El municipio se ha actualizado correctamente',
'El municipio se ha creado correctamente': 'El municipio se ha creado correctamente',
...
'Enlace Dedicado': 'Enlace Dedicado',
'Enlace reportado correctamente': 'Enlace reportado correctamente',
'Enlaces': 'Enlaces',
'Enter a valid email address': 'Enter a valid email address',
'Enter a value': 'No puede ser vacío',
...
'Estado del reporte actualizado correctamente': 'Estado del reporte actualizado correctamente',
'Eventos': 'Eventos',
'Existen errores en el formulario': 'Existen errores en el formulario',
"Existen errores en el formulario<Storage {'id_provincia': 'Value not in database'}>": "Existen errores en el formulario<Storage {'id_provincia': 'Value not in database'}>",
'export as csv file': 'exportar como archivo CSV',
'Export:': 'Export:',
'FAQ': 'Preguntas frecuentes',
'Fecha de Confección': 'Fecha de Confección',
'Fecha de Vencimiento': 'Fecha de Vencimiento',
'file': 'file',
'file ## download': 'file ',
'First name': 'Nombre',
'Folio': 'Folio',
'Formato de fecha incorrecto.': 'Formato de fecha incorrecto.',
...
'La entidad se ha creado correctamente': 'La entidad se ha creado correctamente',
'La reclamacion se ha creado correctamente': 'La reclamacion se ha creado correctamente',
...
'Mostrando 0 de 0 de 0 Enlaces': 'Mostrando 0 de 0 de 0 Enlaces',
'Mostrando 0 de 0 de 0 entidades': 'Mostrando 0 de 0 de 0 entidades',
'Mostrando 0 de 0 de 0 envios': 'Mostrando 0 de 0 de 0 envios',
'Mostrando 0 de 0 de 0 Municipios': 'Mostrando 0 de 0 de 0 Municipios',
'Mostrando 0 to 0 of 0 Enlaces': 'Mostrando 0 to 0 of 0 Enlaces',
'Mostrando 0 to 0 of 0 Entradas': 'Mostrando 0 to 0 of 0 Entradas',
'Mostrando _START_ a _END_ de _TOTAL_ Enlaces': 'Mostrando _START_ a _END_ de _TOTAL_ Enlaces',
'Mostrando _START_ a _END_ de _TOTAL_ entidades': 'Mostrando _START_ a _END_ de _TOTAL_ entidades',
'Mostrando _START_ a _END_ de _TOTAL_ Entradas': 'Mostrando _START_ a _END_ de _TOTAL_ Entradas',
'Mostrando _START_ a _END_ de _TOTAL_ envios': 'Mostrando _START_ a _END_ de _TOTAL_ envios',
'Mostrando _START_ a _END_ de _TOTAL_ Municipios': 'Mostrando _START_ a _END_ de _TOTAL_ Municipios',
'Mostrar _MENU_ Enlaces': 'Mostrar _MENU_ Enlaces',
'Mostrar _MENU_ entidades': 'Mostrar _MENU_ entidades',
'Mostrar _MENU_ Entradas': 'Mostrar _MENU_ Entradas',
'Mostrar _MENU_ envios': 'Mostrar _MENU_ envios',
'Mostrar _MENU_ Municipios': 'Mostrar _MENU_ Municipios',
'Municipio': 'Municipio',
...
'Número': 'Número',
'Número de Identidad Tributaria': 'Número de Identidad Tributaria',
'Número telefónico no válido': 'Número telefónico no válido',
...
'Progreso': 'Progreso',
'Provincia': 'Provincia',
'Provincia actualizada correctamente': 'Provincia actualizada correctamente',
...
'Reportar enlace': 'Reportar enlace',
'Reporte': 'Reporte',
'Reportes': 'Reportes',
